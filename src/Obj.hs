...
sceneFromObj str = (Scene (makeFaces str ++ uwu))
    where uwu =
            let verts = [V3 (-1) 1 2.05, V3 1 1 2.05, V3 (-1) (-1) 2.05, V3 1 (-1) 2.05]
            in  [Triangle (verts!!1) (verts!!3) (verts!!2) (Mat black light)
                ,Triangle (verts!!0) (verts!!1) (verts!!2) (Mat black light)
                ]
    -- very bad
